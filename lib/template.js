...
function build(distDir, targetDir, config) {
  ...
  if (basePath) {
    ...
    htmlTemplate = htmlTemplate
      ...
      .replace(/href\s*=\s*["']changelog\.html["']/, function () { return 'href="' + basePathAttr + '/changelog.html"'; });
  }
  ...
  if (basePath) {
    changelogTemplate = changelogTemplate
      ...
      .replace(/href\s*=\s*["']index\.html["']/, function () { return 'href="' + basePathAttr + '/index.html"'; });
  }
