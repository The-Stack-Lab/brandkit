...
function build(distDir, targetDir, config) {
  ...
  // markup: every "<" is escaped to its JS-string < form (so a value with
  // "</script>" can't break out of the inline script), and all .replace() calls
  // below use function replacers so a "$" in the path isn't read as a $-pattern.
  ...
  if (basePath) {
    htmlTemplate = htmlTemplate
      .replace('href="styles.css"', function () { return 'href="' + basePath + '/styles.css"'; })
      .replace('src="engine.js"', function () { return 'src="' + basePath + '/engine.js"'; });
  }
